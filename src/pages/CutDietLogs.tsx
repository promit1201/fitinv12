...
import { ArrowLeft, Coffee, Apple, Moon, Calendar, Salad, Activity, Plus, Trash2, Lock, Edit2 } from 'lucide-react';
...
const CutDietLogs = () => {
  ...
  const nutritionGoals = [
    { label: 'Calories', value: userGoals?.target_calories ?? 1680, current: totals.calories, color: 'text-primary' },
    { label: 'Protein', value: userGoals?.protein_grams ?? 140, unit: 'g', current: Math.round(totals.protein), color: 'text-green-500' },
    { label: 'Carbs', value: userGoals?.carbs_grams ?? 160, unit: 'g', current: Math.round(totals.carbs), color: 'text-blue-500' },
    { label: 'Fat', value: userGoals?.fat_grams ?? 50, unit: 'g', current: Math.round(totals.fat), color: 'text-yellow-500' },
  ];
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                3 meals per day • 20% calorie deficit for fat loss
              </p>
            </div>
