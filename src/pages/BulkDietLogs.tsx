...
const BulkDietLogs = () => {
  ...
  const nutritionGoals = [
    { label: 'Calories', value: userGoals?.target_calories ?? 2415, current: totals.calories, color: 'text-primary' },
    { label: 'Protein', value: userGoals?.protein_grams ?? 150, unit: 'g', current: Math.round(totals.protein), color: 'text-green-500' },
    { label: 'Carbs', value: userGoals?.carbs_grams ?? 300, unit: 'g', current: Math.round(totals.carbs), color: 'text-blue-500' },
    { label: 'Fat', value: userGoals?.fat_grams ?? 70, unit: 'g', current: Math.round(totals.fat), color: 'text-yellow-500' },
  ];
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground text-lg">
                5 meals per day • 15% calorie surplus for muscle gain
              </p>
            </div>
